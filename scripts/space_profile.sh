...
time ./superset_disasm.native --target ${HOME}/workspace/x86-binaries/elf/binutils/icc_binutils_32_O2_elfedit --rounds=3  --enable_feature="TrimFixpointTails"  --ground_truth_bin=${HOME}/workspace/x86-binaries/elf/binutils/icc_binutils_32_O2_elfedit --tp_threshold=0.96 2>&1 icc_binutils_32_O2_elfedit.spacetime
