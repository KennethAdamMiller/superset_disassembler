...
average_reduced_occlusion = sum(reduced_occlusion_percent) / len(reduced_occlusion_percent)
...
orig_percent_of_memory=sum(percent_of_memory) / len(percent_of_memory)
...
improvement_percent_of_memory=sum(improvement_of_memory) / len(improvement_of_memory)
...
average_true_positives=sum(percent_true_positives) / len(percent_true_positives)
...
avg_tp_of_occlusion=sum(percent_tp_of_occlusion)/len(percent_tp_of_occlusion)
...
avg_tp_of_original=sum(percent_tp_of_original)/len(percent_tp_of_original)
...
avg_icc_of_mem=sum(percent_icc_of_mem)/len(percent_icc_of_mem)
...
avg_icc_improvement=sum(percent_icc_improvement)/len(percent_icc_improvement)
...
avg_tp_of_superset=sum(percent_icc_tp_of_superset)/len(percent_icc_tp_of_superset)
...
avg_tp_of_reduced=sum(percent_icc_tp_of_reduced)/len(percent_icc_tp_of_reduced)
...
avg_gcc_of_mem=sum(percent_gcc_of_mem)/len(percent_gcc_of_mem)
...
avg_percent_gcc_improvement=sum(percent_gcc_improvement)/len(percent_gcc_improvement)
...
avg_gcc_tp_of_superset=sum(percent_gcc_tp_of_superset)/len(percent_gcc_tp_of_superset)
...
avg_gcc_tp_of_reduced=sum(percent_gcc_tp_of_reduced)/len(percent_gcc_tp_of_reduced)
...
avg_x86_original_of_mem=sum(percent_x86_original_of_mem)/len(percent_x86_original_of_mem)
...
avg_x86_improvement=sum(percent_x86_improvement)/len(percent_x86_improvement)
...
avg_x86_of_superset=sum(percent_x86_of_superset)/len(percent_x86_of_superset)
...
avg_x86_of_reduced=sum(percent_x86_of_reduced)/len(percent_x86_of_reduced)
...
avg_x86_64_of_mem=sum(percent_x86_64_original_of_mem)/len(percent_x86_64_original_of_mem)
...
avg_x86_64_of_reduced=sum(percent_x86_64_improvement)/len(percent_x86_64_improvement)
...
avg_x86_64_of_superset=sum(percent_x86_64_of_superset)/len(percent_x86_64_of_superset)
...
avg_x86_64_tp_of_reduced=sum(percent_x86_64_of_reduced)/len(percent_x86_64_of_reduced)
...
print("Best progress overall: ", best_tp_of_reduced)
...
worst_five_names=[binaries[x].split("\t")[1].split("/")[-1] for x in worst_five_indexes]
print("Worst five indexes: ", worst_five_indexes, worst_five_names)
