...
##### multiverse
RUN sudo apt-get install wget && wget https://bootstrap.pypa.io/2.7/get-pip.py && python ./get-pip.py && rm ./get-pip.py && python -m pip install --upgrade pyelftools==0.24 && pip install setuptools_rust && pip install pwntools==3.12.2 && sudo pip uninstall capstone -y
